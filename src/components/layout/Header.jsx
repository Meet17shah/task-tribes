        ...
        <div className="flex-1 max-w-md mx-8">
          <div className="relative">
            ...
            <input
              ...
              className="w-full h-10 pl-10 pr-4 bg-background border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-ring focus:border-transparent transition-all"
            />
          </div>
        </div>
